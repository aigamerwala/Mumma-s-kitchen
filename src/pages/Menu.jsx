      ...
      try {
        const dummyDishes = [
          ...
          },
          {
            ...
            chef: "B. Rao",
            category: "Veg",
            description: "Crispy pancake filled with spiced potato filling.",
            image: "https://via.placeholder.com/300",
            price: 8.99,
            available: 15,
          },
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100">
      <div className="flex flex-1">
        ...
        >
          <h1 className="text-2xl sm:text-3xl font-bold mb-4 mt-20 text-blue-700">
